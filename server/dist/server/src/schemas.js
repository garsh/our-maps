...
exports.ShareSchema = exports.MapCreateSchema = exports.MapUpdateSchema = exports.LayerSchema = exports.PinSchema = void 0;
...
exports.PinSchema = zod_1.z.object({
    ...
    layerId: zod_1.z.string().optional().nullable(),
...
exports.MapUpdateSchema = zod_1.z.object({
    ...
    layers: zod_1.z.array(exports.LayerSchema).optional(),
...
exports.ShareSchema = zod_1.z.object({
    ...
    role: zod_1.z.enum(['view', 'edit', 'owner']),
});
