...
- **Build Verification**: Suggest that the user run `npm run build` and confirm that the build succeeds after every change that would affect the build. Do not run this command yourself.
